...
A3. 敷地内に30台分の無料駐車場を備えています。</pre>
    ...
    const specB = isAkasawaSpec ? `
      <strong style="color:#fff; font-size:0.85rem; border-bottom:1px solid #34d399; padding-bottom:2px; display:inline-block; margin-bottom:6px;">【AI時代に選ばれる宿 RAGナレッジ（reason_to_buy_rag.md）に基づく公式HP改修仕様書】:</strong><br>
      <div style="background:rgba(52,211,153,0.1); border-left:3px solid #34d399; padding:6px 10px; margin:4px 0 8px; font-size:0.73rem; color:#a7f3d0;">
        💡 <strong>根拠と選定基準</strong>: AI検索エンジン（ChatGPT Search, Perplexity, Google AI Overviews）は「特徴の羅列」ではなく「**顧客がこの宿を選ぶ納得の理由（Job/Pain/Gain/Because）**」および「**公式ドメインと一致した機械可読構造化データ**」を読み取って推薦順位を決定します。
      </div>
...
&lt;/script&gt;
    ...
    ` : `
      ...
      1. <strong>Schema.org 4型 完全埋め込み</strong>: <code>&lt;head&gt;</code> 内に公式ドメイン（https://nasu-utopia.jp/）準拠のJSON-LDを記述。<br>
      2. <strong>Rich Results Test 0エラー保証</strong>: 料金・空室・FAQ構造化データを完備。<br>
      3. <strong>実在ファクト完全準拠 (NAP統一)</strong>: 公式ドメイン https://nasu-utopia.jp/ / 0287-73-5007 / 〒329-3215 栃木県那須郡那須町箕輪318 / チェックアウト 11:00。<br>
      4. <strong>amenityFeature 実在設備10項目コード化</strong>: CUBERU/Rekka 貸切バレルサウナ(90分), 那須連山伏流水水風呂(15℃), 150㎡専用ドッグラン付きヴィラ, 那須高原和牛 手ぶら本格BBQ, 無料駐車場30台等。<br>
      5. <strong>AIクローラー専用ナレッジ設置</strong>: <code>/robots.txt</code> でのAI許可 ＆ <code>/llms.txt</code> の常設。<br>
      6. <strong>生テキスト化 ＆ FAQ整備</strong>: 料金・客室・サウナ・BBQ・ペット同伴規約をHTML生テキストで記述し、一問一答FAQ（最低10〜20問）を設置。<br>
      <details style="margin-top:6px; background:#000; padding:8px; border-radius:6px;">
        <summary style="color:#34d399; cursor:pointer; font-size:0.75rem; font-weight:bold;">▶ 埋め込み用 JSON-LD コード例（コピー可）</summary>
        <pre style="margin-top:6px; font-size:0.68rem; color:#34d399; overflow-x:auto;">
&lt;script type="application/ld+json"&gt;
{
  ...
  "@graph": [
    {
      "@type": "Hotel",
      "@id": "https://nasu-utopia.jp/#hotel",
      "name": "那須ユートピア美野沢ヴィラ＆キャンプ",
      "alternateName": "NASU UTOPIA MINOSAWA",
      "description": "旧美野沢小学校を再生したアートリノベーション型プライベートヴィラ。貸切バレルサウナ CUBERU・Rekka、那須連山伏流水水風呂、150㎡ドッグラン付きヴィラ、手ぶら本格BBQを完備。",
      "url": "https://nasu-utopia.jp/",
      "telephone": "+81-287-73-5007",
      ...
      "checkoutTime": "11:00",
      "amenityFeature": [
        { "@type": "LocationFeatureSpecification", "name": "CUBERU/Rekka 貸切バレルサウナ（90分完全貸切）", "value": true },
        { "@type": "LocationFeatureSpecification", "name": "那須連山伏流水かけ流し水風呂（15℃）", "value": true },
        { "@type": "LocationFeatureSpecification", "name": "150㎡プライベートドッグラン付きヴィラ", "value": true },
        { "@type": "LocationFeatureSpecification", "name": "那須高原和牛 手ぶら本格BBQ", "value": true },
        { "@type": "LocationFeatureSpecification", "name": "無料駐車場 30台完備(予約不要)", "value": true }
      ]
    },
    {
      "@type": "HotelRoom",
      "@id": "https://nasu-utopia.jp/#villaA",
      "name": "ヴィラ A（150㎡専用ドッグラン付きヴィラ・定員6名）",
      "description": "専用ドッグラン・BBQデッキ完備の1棟貸切プライベートヴィラ。",
...
appReplacements.forEach(app => {
  ...
  const replacementRules = [
    ...
    [/創作和食/g, '地元の新鮮食材BBQ'],
    [/伊豆/g, '那須高原'],
    [/遠藤正俊オーナー 個人動画＆SNS自動配信システム/g, '那須ユートピア美野沢 支配人ショート動画＆SNS自動配信システム'],
    [/遠藤正俊オーナーの思想・「買う理由」価値発信/g, '那須ユートピア美野沢 支配人「アート×サウナ×大自然」体験価値発信'],
    [/遠藤正俊オーナー/g, '那須ユートピア支配人'],
    [/遠藤正俊/g, '那須ユートピア支配人'],
    [/遠藤オーナー/g, '支配人様'],
    [/遠藤氏/g, '支配人様'],
    [/遠藤/g, '支配人'],
    [/オーナー様/g, '支配人様'],
    [/1\. 🌲 安定を捨てて、50代で自分の生き方に舵を切った決断と思考法/g, '1. 🔥 「ととのう」の、その先へ (CUBERUサウナ / 薪サウナRekka / 那須伏流水水風呂)'],
    [/2\. ⏳ 「他人の価値観」で生きるのをやめ、人生の軸を取り戻す技術/g, '2. 🏫 廃校をアートとサウナで再生したストーリー (旧美野沢小学校リノベーション)'],
    [/3\. 🌍 世界中で大自然を見て気づいた、現代人が疲弊していく本当の原因/g, '3. 🍖 那須高原和牛と星空の手ぶら本格BBQ (地物野菜・焚き火体験)'],
    [/4\. 💡 なぜ価格競争や数字の比較に巻き込まれると不幸になるのか？/g, '4. 🐶 愛犬とノーリードで過ごすプライベートヴィラ (150㎡専用ドッグラン)'],
    [/5\. 🌿 「何もしない時間」を意図的に作れない現代人が余白を取り戻す方法/g, '5. 🌿 大自然の音とアートに浸る、大人の究極のデジタルデトックス'],
    [/安定を捨てて生き方を変えた理由/g, 'ととのうのその先へサウナ体験'],
    [/他人の価値観で生きるのをやめる/g, '廃校アートサウナ再生ストーリー'],
    [/世界中で大自然を見て気づいた人間社会のバグ/g, '那須高原和牛手ぶらBBQ'],
    [/価格競争・数字の競争から抜け出す思考/g, '愛犬と過ごすドッグランヴィラ'],
    [/余白と休息を意識的に作るマインドセット/g, '大自然とアートのデジタルデトックス'],
    [/看板猫/g, '現代アート作品'],
    [/看板ネコ/g, '現代アート作品'],
    [/猫/g, 'アート'],
