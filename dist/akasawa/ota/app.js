...
const DEMO_DATA = {
  rakuten: {
    catchCopy: "塩原温泉 赤沢温泉旅館　自然に過ごす猫とぬる湯に癒される昔ながらの一軒宿",
    description: "那須塩原温泉郷の箒川沿いに佇む宿です。当館名物の源泉掛け流し100%のぬるゆ温泉や、自然に館内で過ごす猫たちを静かに見守る静養空間です（※猫と遊びたい方は徒歩10分の猫カフェをご利用ください）。お料理は地元の食材を使った手作り和食をお楽しみください。無料の駐車場も完備しております。",
    plans: "【スタンダード】赤沢のぬる湯と旬の味覚プラン 16,500円〜"
  },
  jalan: {
    catchCopy: "【自然な猫の見守りと温泉の宿】のんびり、ぬる湯と地場食材の料理を満喫する休日",
    description: "箒川の渓流沿いに静かに佇む温泉宿。名物ぬる湯の露天風呂と大浴場は一晩中入浴可能！自然に過ごす猫たちを静かに見守る静養空間（※猫と遊ぶなら徒歩10分の猫カフェ案内）。ご夕食は地場の山菜や川魚、手作りの蒸し餃子などをアツアツでお届けします。",
