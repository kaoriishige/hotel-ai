const REVIEW_EXAMPLES = [
  ...
  {
    id: 6,
    title: "🐈 自然に過ごす猫たちの見守りと源泉ぬる湯",
    review: "ロビーでのびのびと自然体に過ごす猫たちを見守り、とても心が温まりました。猫たちの自由な気配を感じながらぬる湯の温泉にゆっくり浸かり、静かな渓流のせせらぎを聞いていると、日々の疲れが溶けていくようでした。何もしない贅沢を存分に味わえました（猫と遊びたい時は徒歩10分の猫カフェも便利でした）。"
  }
];
