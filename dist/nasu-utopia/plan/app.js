const DIRECTION_EXAMPLES = [
  {
    id: 1,
    title: "🔥 【本格サウナ×水風呂】『ととのう』のその先へ (極上サウナ＆グランピング)",
    text: "CUBERUコンクリートサウナや薪サウナRekka、那須連山の冷たい地下水風呂で深くととのい、日常の疲労を完全にリセットしたいサウナ好き・カップルをターゲットにした高単価プランを企画したい。"
  },
  {
    title: "🍖 【手ぶら本格BBQ×星空】那須特選牛ステーキとプライベート焚き火プラン",
    text: "準備や片付けは一切不要！那須高原の特選牛肉や地元野菜を豪華に味わい、専用ウッドデッキで満天の星空と焚き火を眺めながら過ごすファミリー・グループ向けプランを企画したい。"
  },
  {
    title: "🐶 【愛犬と同伴宿泊】プライベート天然芝ドッグラン付きヴィラステイ",
    text: "大切な愛犬と一緒に気兼ねなく自然を駆け回り、専用ドッグランヴィラでワンちゃんと一緒にのんびり過ごす愛犬家ファミリー向け高満足度プランを企画したい。"
  },
  {
    title: "🏫 【廃校アート×ノスタルジー】旧美野沢小学校リノベーションと五感の解放",
    text: "現代アート作品が点在する校舎ギャラリーを散策し、デジタルデトックスと贅沢な静寂を満喫したいノスタルジック・アート愛好家向け休日プランを企画したい。"
  }
];
