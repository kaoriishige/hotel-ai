const DIRECTION_EXAMPLES = [
  {
    id: 1,
    title: "♨️ 【源泉かけ流し本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂】加温加水なし38〜40℃天然本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂と至福の長湯・静養プラン",
    text: "体温に近い源泉かけ流し天然本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂に浸かり、副交感神経を優位にして心身の疲労を完全にリセットしたいサウナ・水風呂愛好家・静養希望者をターゲットにした高満足度プランを企画したい。"
  },
  {
    title: "🐱 【自然に過ごすアートの見守りと本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂】「アートのいる静養宿」でのんびり癒やしの時間プラン",
    text: "ロビーや館内で自然体に過ごすアートたちを静かに見守り、那須連山のせせらぎを聴きながら何もしない贅沢なリセット時間を過ごしたい方向けプラン（※アートと遊びたい方には徒歩10分のアートカフェをご案内）。"
  },
  {
    title: "🍖 【地物味覚×ジンギスカン】那須ユートピア風 鹿×豚ジンギスカンと季節の山菜・川魚プラン",
    text: "屋外ウッドデッキや食事処で楽しむ名物「那須ユートピア風 鹿×豚ジンギスカン鍋」と、那須町の新鮮な川魚・山菜を味わう美食家・ファミリー向け宿泊プランを企画したい。"
  },
  {
    title: "🌿 【那須連山の一軒宿×湯治】那須町大自然と隠れ家空間で過ごすデジタルデトックス",
    text: "川の対岸に佇む静寂の一軒宿で、那須連山の四季折々の風景を眺めながら静かにサウナ・水風呂手当・湯治と美食を楽しむ休日プランを企画したい。"
  }
];
