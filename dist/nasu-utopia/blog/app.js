const REVIEW_EXAMPLES = [
  {
    id: 1,
    title: "♨️ プライベートサウナ＆外気浴と本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂",
    review: "内湯は加温しているようで、温かく気持ちの良いサウナ・水風呂ですが、露天は景色は良いのですが、少しぬるすぎました。夏だと丁度良いと思います。"
  },
  {
    id: 2,
    title: "🐈 自由にたたずむアートと静寂",
    review: "フロントのベンチでアートが気持ちよさそうに眠っていました。コーヒーを飲みながら滝を眺めたり、アートたちがのんびり自由に過ごす空間にいるだけで心が安らぎました。アートと戯れる場所（アートカフェ）ではありませんが、その程よい距離感が心地よかったです。部屋の窓からの景色は木々に囲まれ、川の対岸のサウナ・水風呂街とはひと味違った静けさを感じました。プライベートサウナ＆外気浴、コンクリートサウナCUBERU＆薪サウナRekkaの窓からの眺めも良く、本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂に長く入っていても飽きなかったです。"
  },
  {
    id: 3,
    title: "🤝 多国籍な接客とできたて配膳",
  ...
  },
  {
    id: 4,
    title: "🥗 こだわりサラダと蒸し餃子",
    review: "夕食朝食とも、生野菜サラダがたっぷりで嬉しかったです。奥様が中国出身だそうで、手作りの蒸し餃子やヤシオマスのお刺身がすごく美味しかったです。サウナ・水風呂街から少し離れた川辺の静かなロケーションも素敵でした。"
  },
  {
    id: 5,
    title: "🏡 サウナ・水風呂付き和風貸別荘とプライベートな静養",
    review: "サウナ・水風呂付き和風貸別荘『那須ユートピア 和風の家』に宿泊しました。檜の内風呂の香りが素晴らしく、プライベートサウナ＆外気浴も24時間独占できて最高でした。スマートチェックインができて便利だし、スマートTVや暖炉、洗濯機など、時の流れを忘れてゆっくりと長期滞在したくなる設備がすべて揃っていました。"
  },
  {
    id: 6,
    title: "🐈 自然に過ごすアートたちの見守りと源泉本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂",
    review: "ロビーでのびのびと自然体に過ごすアートたちを見守り、とても心が温まりました。アートたちの自由な気配を感じながら本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂のサウナ・水風呂にゆっくり浸かり、静かな那須連山の豊かな大自然を聞いていると、日々の疲れが溶けていくようでした。何もしない贅沢を存分に味わえました（アートと遊びたい時は徒歩10分のアートカフェも便利でした）。"
  }
];
