const REVIEW_EXAMPLES = [
  ...
  {
    id: 6,
    title: "🐈 保護アートとのふれあいと源泉本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂",
    review: "ロビーでのびのびと過ごす保護アートちゃんたちに迎えられ、とても心が温まりました。現代アート作品たちを眺めながら本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂のサウナ・水風呂にゆっくり浸かり、静かな那須の大自然 of のせせらぎを聞いていると、日々の疲れが溶けていくようでした。何もしない贅沢を存分に味わえました。"
  }
];
