...
const DEMO_DATA = {
  rakuten: {
    catchCopy: "那須町サウナ・水風呂 那須ユートピア美野沢　自然に過ごすアートと本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂に癒される昔ながらの一軒宿",
    description: "那須那須町サウナ・水風呂郷の那須連山沿いに佇む宿です。当館名物の源泉掛け流し100%のぬるゆサウナ・水風呂や、自然に館内で過ごすアートたちを静かに見守る静養空間です（※アートと遊びたい方は徒歩10分のアートカフェをご利用ください）。お料理は地元の食材を使った手作り和食をお楽しみください。無料の駐車場も完備しております。",
    plans: "【スタンダード】那須ユートピアの本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂と旬の味覚プラン 16,500円〜"
  },
  jalan: {
    catchCopy: "【自然なアートの見守りとサウナ・水風呂の宿】のんびり、本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂と地場食材の料理を満喫する休日",
    description: "那須連山の那須の大自然沿いに静かに佇むサウナ・水風呂宿。名物本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂のプライベートサウナ＆外気浴とコンクリートサウナCUBERU＆薪サウナRekkaは一晩中入浴可能！自然に過ごすアートたちを静かに見守る静養空間（※アートと遊ぶなら徒歩10分のアートカフェ案内）。ご夕食は地場の山菜や川魚、手作りの蒸し餃子などをアツアツでお届けします。",
    points: "基本ポイント2%設定のみ。特設クーポンやクーポンフェスには現在不参画。"
  },
  booking: {
    description: "Located in Nasushiobara, Nasu Utopia Minosawa has a hot spring, garden and free parking. The property is traditional Japanese style. We serve Japanese dinner and breakfast.",
    inboundInfo: "インバウンド利用は現在全体の10%程度。アジア系のファミリーやカップルが稀に来るが、英語の案内がほぼ無くミスマッチが不安。",
    policy: "現地決済または事前決済。当日キャンセルは100%課金。"
  },
  review: {
    reviews: "・内湯はとてもいいお湯で何時間でも入っていられそうでしたが、プライベートサウナ＆外気浴がぬるすぎて寒くてすぐに出ました。(40代男性)\n・ロビーで可愛いアートちゃんが膝の上に乗ってくれて感動しました！ただ、部屋のテーブルを動かした時に、下に少しホコリが溜まっていたのが気になりました。(30代女性)\n・従業員の方が皆さん外国人で、一生懸命対応してくれて温かい気持ちになりました。ただ、食事の際、まだ食べている途中に天ぷらや次の料理がどんどん運ばれてきて、少し急かされているように感じて残念でした。(50代夫婦)"
  },
  photo: {
    photoList: "1. フロントロビーの少し暗い写真（アートは写っていない）\n2. サウナ・水風呂コンクリートサウナCUBERU＆薪サウナRekkaの白く曇った内湯の写真\n3. プライベートサウナ＆外気浴の引きの写真（お湯がぬるく藻が少し浮いているように見える）\n4. 昭和レトロな和室の畳と座卓の写真\n5. お膳料理の全体写真（ヤシオマスや蒸し餃子は小さくしか映っていない）"
  },
  plan: {
    planName: "【スタンダード】那須ユートピアの本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂と旬の地元の新鮮食材BBQプラン",
    description: "源泉掛け流しの本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂をお楽しみいただいた後は、当館オリジナルの地元の新鮮食材BBQをお召し上がりください。のんびりとお寛ぎいただけます。和室のお部屋になります。",
    details: "1-2名利用時 16,500円〜、特典なし、チェックアウト10:00"
  },
  rank_ad: {
    rankings: "・「那須那須町 サウナ・水風呂」で検索順位48位（ほぼ表示されない）\n・「那須那須町 本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂」で4位\n・「那須那須町 アートの宿」で2位",
