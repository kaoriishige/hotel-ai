...
const DEMO_DATA = {
  rakuten: {
    catchCopy: "那須町サウナ・水風呂 那須ユートピア美野沢　アートとぬるゆに癒される昔ながらの一軒宿",
    description: "那須那須町サウナ・水風呂郷の那須連山沿いに佇む宿です。当館名物の源泉掛け流し100%のぬるゆサウナ・水風呂や、現代アート作品たちがお出迎えします。お料理は地元の食材を使った手作り和食をお楽しみください。無料の駐車場も完備しております。",
    plans: "【スタンダード】那須ユートピアの本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂と旬の味覚プラン 16,500円〜"
  },
  jalan: {
    catchCopy: "【アートとサウナ・水風呂の宿】のんびり、本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂と地場食材の料理を満喫する休日",
    description: "那須連山の那須の大自然沿いに静かに佇むサウナ・水風呂宿。名物本格フィンランドサウナ（CUBERU / Rekka）と那須連山の水風呂のプライベートサウナ＆外気浴とコンクリートサウナCUBERU＆薪サウナRekkaは一晩中入浴可能！現代アート作品たちがロビーでお出迎えします。ご夕食は地場の山菜や川魚、手作りの蒸し餃子などをアツアツでお届けします。",
