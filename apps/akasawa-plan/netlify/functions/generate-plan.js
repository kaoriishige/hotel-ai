...
exports.handler = async (event) => {
  ...
  try {
    ...
    0. **【施設固有ミッション・コンセプトからの無脱線原則】**:
       - 各宿の核となるミッション・強み（塩原温泉 赤沢温泉旅館なら『源泉かけ流し38〜40℃天然ぬる湯、看板猫のおもてなし、箒川を望む静寂一軒宿、赤沢風 鹿×豚ジンギスカンで心身を深くリセットする時間』）から絶対にブレない、宿の個性が活きたプランを作成してください。
    1. **【AI時代に選ばれる宿泊プラン7原則の厳格適用】**:
       - **① 1行結論の冒頭配置**: プラン説明文の最初の1〜2行に、AIがそのまま引用・推薦できる1行要訳文（例: 「塩原温泉・源泉かけ流しぬる湯・看板猫のおもてなし・箒川一軒宿・鹿肉ジンギスカン」）を置くこと。
       - **② 数値と具体ファクトの徹底**: 「天然ぬる湯38〜40℃」「那須塩原駅よりバス・車アクセス / 無料駐車場30台」など数値を明記すること。
       - **③ ターゲット属性の明示**: タイトル冒頭に【猫とぬる湯】【天然ぬる湯静養】【赤沢風ジンギスカン】など対象ペルソナを【】で付与すること。
    ...
    3. **【市場調査・価格意味づけ】**:
       - 単なる安売りではなく、なぜこの価格に価値があるのか（加温加水なし天然ぬる湯、看板猫の癒やし、地物食体験）を理由として説明してください。
